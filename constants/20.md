...
Newman showed in [N1976] that there exists a finite constant $C_{20}$ (the de Bruijn–Newman constant) such that the zeros of $H$ are all real precisely when $\lambda \geq C_{20}$.
...
- The Riemann hypothesis holds iff $C_{20} = 0$, so the lower bound likely cannot be proved upon.
