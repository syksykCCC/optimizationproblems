...
| Bound | Reference | Comments |
| ----- | --------- | -------- |
| $2$ | [DMPSS2014] | Diniz--Mu\~noz-Fern\'andez--Pellegrino--Seoane-Sep\'ulveda prove the general lower bound $B_{\mathbb R,m}\ge 2^{1-\frac1m}$ for every $m\ge 2$. Taking $\sup_m$ gives $C_{26b}\ge 2$. (For $m=2$ this is sharp: $B_{\mathbb R,2}=\sqrt{2}$, i.e. Littlewood's $4/3$ inequality.) |

## Additional comments and links

- The exponent $\frac{2m}{m+1}$ in the multilinear Bohnenblust--Hille inequality is sharp. [CP2018]
- **Universality Conjecture (Pellegrino--Teixeira).** The optimal Bohnenblust--Hille constants should be bounded uniformly in $m$; in the real case, they conjecture the sharp values
  
  $B_{\mathbb R,m}=2^{1-\frac1m}$ for all $m$,
  
  which would imply the exact value $C_{26b}=2$. [PT2016]
